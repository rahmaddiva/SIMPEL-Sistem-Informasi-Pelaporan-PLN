                    ...
                    <form>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <select class="form-control select2" id="id_pegawai" name="id_pegawai" disabled>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control select2" id="id_perangkat" name="id_perangkat" disabled>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai"
                                    value="<?= $gangguan['tanggal_mulai'] ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control select2" id="id_gi" name="id_gi" disabled>
                                    <option value="">-- Pilih Gardu Induk --</option>
                                    <?php foreach ($gardu_induk as $gi): ?>
                                        <option value="<?= $gi['id'] ?>" <?= $gi['id'] == $gangguan['id_gi'] ? 'selected' : '' ?>>
                                            <?= $gi['nama_gi'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4"
                                    readonly><?= $gangguan['deskripsi'] ?></textarea>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="foto" class="form-label">Foto Gangguan</label>
