        ...
        <div class="col-lg-12">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <!-- Form Tambah Keluhan -->
                    <form action="/proses-keluhan" method="POST" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <img id="previewImage" src="#" alt="Preview Foto"
                                    style="display: none; width: 500px; height: 500px; object-fit: cover; border: 1px solid #ddd; padding: 5px;">
                            </div>
                        </div>

                        <button type="submit" class="btn btn-success mt-3">Tambah Keluhan</button>
...
<!-- Tambahkan Script Select2 dan Preview Foto -->
