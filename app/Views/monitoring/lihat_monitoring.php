            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex align-items-center justify-content mb-4">
                        <a href="/monitoring_keluhan" class="btn btn-primary mb-3"><i class="fas fa-arrow-left"></i>
                            Kembali</a>
                        <!-- cetak laporan monitoring -->
                        <a href="/cetak_monitoring_keluhan" class="btn btn-success mb-3 ml-2"><i
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Progress <?= $row['nama_pengajuan'] ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/update-progress-keluhan/<?= $row['id_keluhan'] ?>" method="post"
                    ...
                    <div class="modal-body row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="" name="" value="<?= date('Y-m-d') ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
